...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  api.createGame().then(function (response) {
	    ...
	    return store;
	  }).then(board.clearBoard(event)).then(ui.success).catch(ui.failure);
	};

	var onShowGames = function onShowGames(event) {
	  event.preventDefault();
	  api.getAllGames().then(ui.showGamesSuccess).catch(ui.failure);
	};

	var onGetGame = function onGetGame(event) {
	  event.preventDefault();
	  var id = parseInt($('.gameid').val());
	  api.getGame(id).then(ui.getGameSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameBoard = ['', '', '', '', '', '', '', '', ''];
	var over = false;
	var playSymbol = void 0;
	var currentPlayTurn = void 0;

	// Message for who's turn it is
	var messageText = function messageText(currentPlayer) {
	...
	var symbolValue = function symbolValue(player, divClassNum) {
	  if (player === playerX) {
	...
	var isSpaceEmpty = function isSpaceEmpty(squareNum) {
	...
	var isWinner = function isWinner(arr) {
	  ...
	  var winComboOneX = arraysEqual(tempArrayX, winOne);
	  var winComboTwoX = arraysEqual(tempArrayX, winTwo);
	  var winComboThreeX = arraysEqual(tempArrayX, winThree);
	  var winComboFourX = arraysEqual(tempArrayX, winFour);
	  var winComboFiveX = arraysEqual(tempArrayX, winFive);
	  var winComboSixX = arraysEqual(tempArrayX, winSix);
	  var winComboSevenX = arraysEqual(tempArrayX, winSeven);
	  var winComboEightX = arraysEqual(tempArrayX, winEight);
	  var winComboOneY = arraysEqual(tempArrayY, winOne);
	  var winComboTwoY = arraysEqual(tempArrayY, winTwo);
	  var winComboThreeY = arraysEqual(tempArrayY, winThree);
	  var winComboFourY = arraysEqual(tempArrayY, winFour);
	  var winComboFiveY = arraysEqual(tempArrayY, winFive);
	  var winComboSixY = arraysEqual(tempArrayY, winSix);
	  var winComboSevenY = arraysEqual(tempArrayY, winSeven);
	  var winComboEightY = arraysEqual(tempArrayY, winEight);
	...
	function clearBoard(event) {
	  ...
	  $('.game-board-container div').on('click', function () {
	    ...
	    var divClassNum = parseInt(divClass);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(6);
	var store = __webpack_require__(10);
	var gameStore = __webpack_require__(15);
	...
	var updateGame = function updateGame(id, gamePiece, isOver) {
	  console.log(store);
	  console.log(id);
	  return $.ajax({
